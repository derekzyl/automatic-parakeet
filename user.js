const scraperObject = async (browser, url) => {
  ...
  await page.evaluate(() => {
    ...
    user.banner_image =
      document.querySelector(".Image--image")[0] &&
      document.querySelector(".Image--image")[0].src;
    user.profile_image =
      document.querySelectorAll(".Image--image")[1] &&
      document.querySelectorAll(".Image--image")[1].src;
    user.name =
      document.querySelector(".AccountHeader--title") &&
      document.querySelector(".AccountHeader--title").textContent.trim();
    user.username =
      document.querySelector(".AccountHeader--title") &&
      "@" + document.querySelector(".AccountHeader--title").textContent.trim();
    ...
    user.instagram =
      document.querySelectorAll(".AccountLinksBar--icon-button")[1] &&
      document.querySelectorAll(".AccountLinksBar--icon-button")[1].href;
    user.twitter =
      document.querySelectorAll(".AccountLinksBar--icon-button")[2] &&
      document.querySelectorAll(".AccountLinksBar--icon-button")[2].href;
